    ...
    return (
        ...
        >
            ...
            >
                ...
                <h2 className="reveal-yoga text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extralight uppercase tracking-tight leading-none text-white mb-6">
                    Encontre o <br />
                    <span className="font-serif italic font-light text-[#bda07a] capitalize tracking-normal">Seu Eixo</span>
                </h2>
                
                <p className="reveal-yoga text-sm sm:text-base md:text-lg text-zinc-300 font-light max-w-lg leading-relaxed">
                    Conexão profunda entre corpo, respiração e mente para potencializar seus resultados físicos, restaurar a mobilidade e blindar suas articulações.
                </p>
                ...
                <div className="reveal-yoga mt-10 flex flex-col items-center gap-3">
                    ...
                    <span className="text-[7px] tracking-[0.3em] uppercase text-zinc-500 font-bold">Conexão Ativa</span>
                </div>
            </div>
        </section>
    )
